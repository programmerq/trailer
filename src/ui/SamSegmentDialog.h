...
class SamPromptCanvas : public QWidget {
  ...
  public:
    ...
    bool hasAnyPrompt() const { return !m_positives.isEmpty() || !m_negatives.isEmpty(); }
    void clearPrompts();
...
class SamSegmentDialog : public QDialog {
  ...
  public:
    ...
    SamSegmentDialog(Mode mode, const QImage &source, SamSession *session,
