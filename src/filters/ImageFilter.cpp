...
template <typename Fn> QImage transformPixels(const QImage &src, Fn fn) {
    if (src.isNull())
        return src;
...
QImage lighten(const QImage &src) {
    ...
    return transformPixels(src, [](int r, int g, int b, int a) {
        return qRgba(clamp8(r + kBoost), clamp8(g + kBoost), clamp8(b + kBoost), a);
    });
}
...
QString filterId(ImageFilter f) {
    ...
    case ImageFilter::BlackAndWhite:
        return QStringLiteral("black_and_white");
    case ImageFilter::Greyscale:
        return QStringLiteral("greyscale");
    case ImageFilter::Sepia:
        return QStringLiteral("sepia");
    case ImageFilter::Lighten:
        return QStringLiteral("lighten");
    case ImageFilter::BlueTone:
        return QStringLiteral("blue_tone");
    case ImageFilter::GreyTone:
        return QStringLiteral("grey_tone");
    }
    return QStringLiteral("none");
}

ImageFilter filterFromId(const QString &id) {
    if (id == QLatin1String("black_and_white"))
        return ImageFilter::BlackAndWhite;
    if (id == QLatin1String("greyscale"))
        return ImageFilter::Greyscale;
    if (id == QLatin1String("sepia"))
        return ImageFilter::Sepia;
    if (id == QLatin1String("lighten"))
        return ImageFilter::Lighten;
    if (id == QLatin1String("blue_tone"))
        return ImageFilter::BlueTone;
    if (id == QLatin1String("grey_tone"))
        return ImageFilter::GreyTone;
...
QString filterDisplayName(ImageFilter f) {
    ...
    case ImageFilter::Lighten:
        return QStringLiteral("Lighten");
    case ImageFilter::BlueTone:
        return QStringLiteral("Blue Tone");
    case ImageFilter::GreyTone:
        return QStringLiteral("Grey Tone");
    }
    return QStringLiteral("None");
}
...
QList<ImageFilter> allFilters() {
    return {
        ImageFilter::None,     ImageFilter::BlackAndWhite, ImageFilter::Greyscale,
        ImageFilter::Sepia,    ImageFilter::Lighten,       ImageFilter::BlueTone,
