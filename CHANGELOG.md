...
- **Page-mode keyboard shortcuts.** `Cmd-1` / `Cmd-3` (Ctrl on
  Windows/Linux) switch to Single Page / Continuous view. `Cmd-2`
  (Two Pages) is reserved for a future facing-page layout.
