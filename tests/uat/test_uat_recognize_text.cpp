...
void TestUatRecognizeText::uat_ocr_020_recognizeTextProducesBlocksWithRealModels() {
    ...
    for (const auto &b : blocks) {
        ...
        QVERIFY2(bounds.intersects(source.rect()), "Block polygon should overlap the source image");
    }
